            ...
            <td class="center center670" valign="top">
                    ...
                    <tr>
                        ...
                        <td class="titleCenter titleCenter670" valign="top">
                            <div class="titleText titleText670">
                                <span class="bannerNormalTitle fk_mainTitle mainTitle mainTitle670">文章集锦</span>
                            </div> </td>
                ...
                <div class="formBannerOther formBannerOther670">
                    <div class="formBannerMore formBannerMore670" style="">
                        <span style="_display:inline-block;_position:relative;"> <a hidefocus="true" class="bannerMoreInnerA" href="{{url('more_new')}}"><span class="bannerMoreInnerSpan">更多&gt;&gt;</span></a> </span>
                    </div>
                                    ...
                                    <table id="lineBody106" class="J_lineBody lineBody" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr id="module670tr106">
                                            ...
                                            <td class="J_newsTitle newsTitle" valign="top">
                                                <div class="J_newsListTopFlag "></div> <a class="fk-newsListTitle" hidefocus="true" href="{{route('imagenews.show',$new->id)}}" target="_blank" title="{{$new->title}}">{{$new->title}}</a> </td>
