...
<head>
	...
	<link type="text/css" href="{{asset('css/detail2.min.css?v=201805241904')}}" rel="stylesheet" />
									...
									<td class="containerMiddleCenter">
										...
										<div id="containerForms" class="containerForms">
											<div id="topForms" class="column forms mainForms topForms">
												<div id="module399" _indexclass="formIndex1" _moduletype="1" _modulestyle="35" _moduleid="399" class="form form399 formIndex1 formStyle35 layoutModule  formStyle35_2  fk-formCol " title="" _sys="0" _banid="" style="" _side="0" _intab="0" _inmulmcol="0" _infullmeasure="0" _inpack="0" _inpopupzone="0" _autoheight="1" _global="false" _independent="false">
													...
													<table class=" formMiddle formMiddle399" style="" cellpadding="0" cellspacing="0">
														...
														<tr>
															...
															<td class="formMiddleCenter formMiddleCenter399  f-colFormMiddleCenter " valign="top">
																<div class="formMiddleContent formMiddleContent399 multiColFormMiddleContent f-colFormMiddleContent  fk-formContentOtherPadding" tabstyle="0">
																	<div class="mulMColContent" id="mulMColContent399">
																		<table width="100%" border="0" cellspacing="0" class="mulMColContentTable" cellpadding="0">
																			<tbody>
																			<tr>
																				<td class=" mulColLayout mulColPadding" style="width:290px;">
																					<div id="mulMCol399_cid_1" class="mulMColList">
																						@include('home2.layouts.newsidebar')
																					</div>
																					<div class="mulModuleColStyleLine" style=""></div></td>
																				<td class="mulColLayout" style="">
																					<div id="mulMCol399_cid_2" class="mulMColList">
																						<div id="module12" _indexclass="" _moduletype="12" _modulestyle="103" _moduleid="12" class="form form12 formStyle103 formInMulMCol " title="" _sys="0" _banid="" style="" _side="0" _intab="0" _inmulmcol="399" _infullmeasure="0" _inpack="0" _inpopupzone="0" _autoheight="1" _global="false" _independent="false">
																							<table class="formTop formTop12" cellpadding="0" cellspacing="0">
																								...
																								@include('home2.layouts.newcontent')
