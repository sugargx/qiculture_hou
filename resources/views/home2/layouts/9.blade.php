@php
        $newtypes = \App\Http\Model\NewType::where('flag','管子学刊')->get();
        if(count($newtypes)>0){
            $newtype = $newtypes[0];
                ...
                <td class="center center731" valign="top">
                        ...
                        <tr>
                            ...
                            <td class="titleCenter titleCenter731" valign="top">
                                <div class="titleText titleText731">
                                    <span class="bannerNormalTitle fk_mainTitle mainTitle mainTitle731">@if(isset($newtype)){{$newtype->name}}@endif</span>
                                </div> </td>
                    ...
                    <div class="formBannerOther formBannerOther731">
                        <div class="formBannerMore formBannerMore731" style="">
                            <span style="_display:inline-block;_position:relative;"> <a hidefocus="true" class="bannerMoreInnerA" href="@if(isset($newtype)){{url("newtype/$newtype->id" )}}@endif"><span class="bannerMoreInnerSpan">更多&gt;&gt;</span></a> </span>
                        </div>
            ...
            <div class="floatImg floatImg_J floatImg_J_special">
                <a hidefocus="true" href="@if(count($news)>=1){{route('news.show',$news[0]->id)}}@endif" class="J_floatImg_jump f_floatImg_jump ">
                    <div class="floatImgWrap">
                        <div class="forMargin">
                            <img id="float_img_734" class="float_in_img J_defImage " src="@if(count($news)>=1){{asset($news[0]->image)}}@endif" alt="ABUIABACGAAgp53S0gUot4y-6wYw_wM4yQU" style="width:136px;height: 177px;"/>
                        </div>
                    </div></a>
            </div>
        </div>
        ...
        <div class="lightModuleOuterContent lightModuleOuterContent735">
            <div class="floatImg floatImg_J floatImg_J_special">
                <a hidefocus="true" href="@if(count($news)>=1){{route('news.show',$news[0]->id)}}@endif" class="J_floatImg_jump f_floatImg_jump ">
                    <div class="floatImgWrap">
                        <div class="forMargin">
                            <img id="float_img_735" class="float_in_img J_defImage " src="@if(count($news)>=2){{asset($news[1]->image)}}@endif" alt="ABUIABACGAAg353S0gUo0PW9pgQwiAI45gI" style="width:136px;height: 177px;"/>
                        </div>
                    </div></a>
            </div>
        </div>
        ...
        <div class="lightModuleOuterContent lightModuleOuterContent736">
            <div class="floatImg floatImg_J floatImg_J_special">
                <a hidefocus="true" href="@if(count($news)>=1){{route('news.show',$news[0]->id)}}@endif" class="J_floatImg_jump f_floatImg_jump ">
                    <div class="floatImgWrap">
                        <div class="forMargin">
                            <img id="float_img_736" class="float_in_img J_defImage " src="@if(count($news)>=3){{asset($news[2]->image)}}@endif" alt="ABUIABACGAAg3Z3S0gUozNW1rQQw5AE4twI" style="width:136px;height: 177px;"/>
                        </div>
                    </div></a>
            </div>
        </div>
